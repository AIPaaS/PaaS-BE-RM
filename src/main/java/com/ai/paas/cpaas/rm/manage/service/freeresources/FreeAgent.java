...
public class FreeAgent implements Tasklet {
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    TaskUtil.uploadFile("freeagent.yml", content, useAgent, aid);
    ...
    AnsibleCommand dockerinstall =
        new AnsibleCommand(TaskUtil.getSystemProperty("filepath") + "/freeagent.yml",
    ...
    try {
      ...
      int taskId =
          TaskUtil.insertResJobDetail(start, openParam.getClusterId(), dockerinstall.toString(),
              TaskUtil.getTypeId("freeAgent"), status);
