...
public class SlaveInstallDocker implements Tasklet {

  private static Logger logger = Logger.getLogger(SlaveInstallDocker.class);
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    InputStream in =
        OpenPortUtil.class.getResourceAsStream("/playbook/increasesources/dockerinstall.yml");
    ...
    MesosSlave instance = mesosSlave.get(0);
    ...
    try {
      ...
      int taskId =
          TaskUtil.insertResJobDetail(start, openParam.getClusterId(), dockerinstall.toString(),
              TaskUtil.getTypeId("slaveInstallDocker"), status);
