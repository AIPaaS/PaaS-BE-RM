...
public class OpenPortUtil {
  private static Logger logger = Logger.getLogger(OpenPortUtil.class);
  ...
  public static RepeatStatus openPort(ChunkContext chunkContext, String portParam, String user,
    ...
    /*
     * String password = (String) chunkContext.getStepContext().getStepExecution().getJobExecution()
    ...
    AnsibleCommand openPortCommand =
        new AnsibleCommand(TaskUtil.getSystemProperty("filepath") + "/openport.yml", "root",
            portVars);
