...
public class MesosDnsInstall implements Tasklet {
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext)
    ...
    for (String filename : filenames) {
      InputStream in = OpenPortUtil.class.getResourceAsStream("/playbook/docker/" + filename);
    ...
    masters.append("\"").append(this.genMesosInfo(masterInstance.getIp())).append("\"");
    ...
    configvars.add("resolvers='\"resolvers\": [" + nameserver + "],'");
